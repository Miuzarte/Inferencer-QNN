...
type (
	...
	AllocatorType                int32
	MemType                      int32
	MemoryInfoDeviceType         int32
	DeviceMemoryType             int32
)
...
// MemoryInfo device types
const (
	MemoryInfoDeviceType_CPU  MemoryInfoDeviceType = 0
	MemoryInfoDeviceType_GPU  MemoryInfoDeviceType = 1
	MemoryInfoDeviceType_FPGA MemoryInfoDeviceType = 2
	MemoryInfoDeviceType_NPU  MemoryInfoDeviceType = 3
)

// Device memory types
const (
	DeviceMemoryType_DEFAULT         DeviceMemoryType = 0
	DeviceMemoryType_HOST_ACCESSIBLE DeviceMemoryType = 5
)
...
type apiFuncs struct {
	...
	// EP registration
	registerExecutionProviderLibrary func(EnvHandle, *byte, unsafe.Pointer) StatusHandle

	// EP devices
	getEpDevices                            func(EnvHandle, **uintptr, *uintptr) StatusHandle
	epDeviceEpName                          func(uintptr) *byte
	sessionOptionsAppendExecutionProviderV2 func(SessionOptionsHandle, EnvHandle, *uintptr, uintptr, **byte, **byte, uintptr) StatusHandle
	...
	addSessionConfigEntry                 func(SessionOptionsHandle, *byte, *byte) StatusHandle
	...
	// io binding
	createIoBinding          func(SessionHandle, *IoBindingHandle) StatusHandle
	releaseIoBinding         func(IoBindingHandle)
	bindInput                func(IoBindingHandle, *byte, ValueHandle) StatusHandle
	bindOutput               func(IoBindingHandle, *byte, ValueHandle) StatusHandle
	bindOutputToDevice       func(IoBindingHandle, *byte, MemoryInfoHandle) StatusHandle
	getBoundOutputNames      func(IoBindingHandle, AllocatorHandle, *unsafe.Pointer, *unsafe.Pointer, *uintptr) StatusHandle
	getBoundOutputValues     func(IoBindingHandle, AllocatorHandle, *unsafe.Pointer, *uintptr) StatusHandle
	clearBoundInputs         func(IoBindingHandle)
	clearBoundOutputs        func(IoBindingHandle)
	runWithBinding           func(SessionHandle, uintptr, IoBindingHandle) StatusHandle
	synchronizeBoundInputs   func(IoBindingHandle) StatusHandle
	synchronizeBoundOutputs  func(IoBindingHandle) StatusHandle
	createMemoryInfo         func(*byte, AllocatorType, int32, MemType, *MemoryInfoHandle) StatusHandle
	createMemoryInfo_V2      func(*byte, MemoryInfoDeviceType, uint32, int32, DeviceMemoryType, uintptr, AllocatorType, *MemoryInfoHandle) StatusHandle
}
